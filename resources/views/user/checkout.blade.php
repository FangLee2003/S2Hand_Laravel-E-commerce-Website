                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input class="form-control form-control-lg" type="tel" id="phone" name="phone"
                                       placeholder="e.g. +02 245354745" value="{{Auth::user()->email}}">
                            </div>
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                                <label class="form-label text-sm text-uppercase" for="postcode">Postcode </label>
                            ...
                            <div class="col-lg-12">
                                <label class="form-label text-sm text-uppercase" for="address1">Address line 1 </label>
                            ...
                            <div class="col-lg-12">
                                <label class="form-label text-sm text-uppercase" for="notes">Order notes
                                </label>
                        ...
                        <div class="card border-0 rounded-0 p-lg-4 bg-light">
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled mb-0">
                                    ...
                                    @endforeach
                                    <li class="d-flex align-items-center justify-content-between"><strong
                                            class="text-uppercase small fw-bold">Total</strong><span>${{$sum}}</span>
                                    </li>

                                </ul>
                                <button class="btn btn-dark form-control mt-4" type="submit">Place order</button>
                            </div>
                        </div>
                    </div>
                </div>
